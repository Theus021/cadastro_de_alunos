...
"}")
        ...
        self.nome_tabela_label.setGeometry(QRect(60, 50, 881, 40))
        font = QFont()
...
"}")
        ...
        self.widget_3.setGeometry(QRect(60, 140, 881, 411))
...
"")
        ...
        self.buscar_input.setGeometry(QRect(490, 20, 191, 31))
        font2 = QFont()
...
"}")
        ...
        self.editarr_button.setGeometry(QRect(699, 12, 171, 80))
...
"}")
        ...
        self.tableWidget_2.setGeometry(QRect(10, 100, 681, 300))
        self.tableWidget_2.setFont(font1)
        self.tableWidget_2.setStyleSheet(u"QTableWidget{\n"
"background:#FFF;}")
        self.label = QLabel(self.widget_3)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(10, 12, 681, 80))
...
"background: #FFF}")
        ...
        self.adicionar_aluno_button.setGeometry(QRect(710, 120, 151, 80))
...
"border: 3px #solid #CCC}")
        ...
        self.label_2.setGeometry(QRect(700, 100, 171, 301))
...
"background: #FFF}")
        ...
        self.adicionar_prof_button.setGeometry(QRect(710, 210, 151, 80))
...
"border: 3px #solid #CCC}")
        ...
        self.adicionar_turma_button = QPushButton(self.widget_3)
        self.adicionar_turma_button.setObjectName(u"adicionar_turma_button")
        self.adicionar_turma_button.setGeometry(QRect(710, 300, 151, 80))
        self.adicionar_turma_button.setFont(font2)
        self.adicionar_turma_button.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.adicionar_turma_button.setStyleSheet(u"QPushButton{\n"
"background: #32CD32;\n"
"color: #FFF;\n"
"border-radius:3px;\n"
"}\n"
...
"border: 3px #solid #CCC}")
        ...
        self.adicionar_turma_button.setIconSize(QSize(30, 30))
        ...
        self.filtro_comboBox.setGeometry(QRect(490, 55, 191, 31))
...
" }")
        ...
        self.search_input.setGeometry(QRect(20, 55, 451, 31))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.nome_tabela_label.setText(QCoreApplication.translate("MainWindow", u"Tabela de Alunos", None))
        ...
        self.adicionar_turma_button.setText(QCoreApplication.translate("MainWindow", u"Turma", None))
